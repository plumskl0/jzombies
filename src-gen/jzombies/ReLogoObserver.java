...
public class ReLogoObserver extends BaseObserver{
	...
	public AgentSet<jzombies.relogo.UserTurtle> createUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("jzombies.relogo.UserTurtle")
	public AgentSet<jzombies.relogo.UserTurtle> createUserTurtles(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("jzombies.relogo.UserTurtle")
	public AgentSet<jzombies.relogo.UserTurtle> createOrderedUserTurtles(int number, Closure closure) {
		AgentSet<jzombies.relogo.UserTurtle> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("jzombies.relogo.UserTurtle")
	public AgentSet<jzombies.relogo.UserTurtle> createOrderedUserTurtles(int number) {
	...
	public AgentSet<jzombies.relogo.UserTurtle> userTurtles(){
		...
		for (Object e : this.getContext().getObjects(jzombies.relogo.UserTurtle.class)) {
	...
	public AgentSet<jzombies.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(jzombies.relogo.UserLink.class)) {
	...
	public jzombies.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (jzombies.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
